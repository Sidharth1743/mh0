...
export default function AvailabilityScreen() {
    ...
    const pulseStyle = useAnimatedStyle(() => ({
        transform: [{ scale: buddy.scale.value }],
        opacity: interpolate(buddy.scale.value, [1, 1.1], [0.1, 0.3]),
    }));
                ...
                <View style={styles.footer}>
                    <Animated.View entering={FadeInUp.delay(600)}>
                        <TouchableOpacity
                            ...
                            disabled={!selected}
                            onPress={() => {
                                updateData({ availability: selected });
                                router.push('/onboarding/matching-tease');
                            }}
                        >
